...
<head>
	<title>Organ Donation Management System | Home Page</title>
				...
				<li>
					<div class="banner-top1">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>Organ bank services that you
									<span>can trust</span>
								</h3>
...
{ ?>
				<div class="col-md-4 pricing" style="margin-top:2%;">
					...
					<div class="price-bottom p-4">
						...
						<p class="card-text"><b>Organ Type :</b> <?php echo htmlentities($result->BloodGroup);?></p>
	...
	<div class="screen-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Organ Types</h3>
				<span>
					<i class="fas fa-user-md"></i>
				</span>
				<p class="mt-2">Ogans of any human being will mainly fall in any one of the following groups..</p>
			</div>
			<div class="row">
            <div class="col-lg-6">
