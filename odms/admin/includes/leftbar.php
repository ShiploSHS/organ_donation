...
<li><a href="#"><i class="fa fa-files-o"></i> Organ Type</a>
<ul>
<li><a href="add-bloodgroup.php">Add Organ</a></li>
<li><a href="manage-bloodgroup.php">Manage Organs</a></li>
</ul>
</li>
			...
			<li><a href="blood-requests.php"><i class="fa fa-users"></i> Organ Requests</a></li>
<li><a href="request-received-bydonar.php"><i class="fa fa-search"></i>Search Organ Request</a></li>
